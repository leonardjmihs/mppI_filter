...
class GSF_Controller_Expanded:
    def __init__(self, nlmodel, planner,
                 ...
                 wmin=1e-6,
                 gamma=4.0,
                 ukf_alpha=1e-1, ukf_beta=2.0, ukf_kappa=0.0):
...
# tree_util.register_pytree_node(GSF_Controller_Expanded,
#                                GSF_Controller_Expanded._tree_flatten,
#                                GSF_Controller_Expanded._tree_unflatten)
# ------------------ main driver ------------------
def do_gsf(params):
    """
