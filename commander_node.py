...
class CommanderNode(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(PoseStamped, "/goal_pose", self.local_goal_cb, 1, callback_group=goal_cb_group)
        self.create_subscription(Odometry, "odom", self.set_goal, 1)
        
        self.goal_tf_buffer: Buffer = Buffer()
        self.goal_tf_listener = TransformListener(self.goal_tf_buffer, self)
